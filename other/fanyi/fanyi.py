...
def crt_tbl_blog_blogspost(cu, flag):
    ...
    insert_sql = 'insert into nvts_en select id, oid , name, tag, cn_ok, ' + \
        ...
        'from blog_blogspost where cn_ok = \'0\'  ORDER BY id ;'
...
if __name__ == "__main__":
    ...
    if param_len != 3:
        sys.exit('input param need 2,useage:python3 ' +sys.argv[0] + ' continue/first tasks.db')
    else:
        if 'continue' == sys.argv[1]:
            ...
            sys.exit('input param error,useage:python3 ' +sys.argv[0] + ' continue/first tasks.db')
