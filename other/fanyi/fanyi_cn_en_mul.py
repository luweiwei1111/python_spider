...
if __name__ == "__main__":
    ...
    if param_len != 3:
        sys.exit('input param need 2,useage:python3 ' +sys.argv[0] + ' continue/first all/500')
    else:
        if 'continue' == sys.argv[1]:
            ...
            sys.exit('input param error,useage:python3 ' +sys.argv[0] + ' continue/first all/100')
